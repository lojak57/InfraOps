		...
		{:else if activeTab === 'operations'}
			<div class="operations-section">
				<div class="operations-metrics">
					...
					/>
					<MetricCard 
						title="FlowOps Impact: Temperature Compliance" 
						value="98" 
						unit="%" 
						icon={Shield}
						status="normal"
...
<style>
	...
	/* Force consistent card heights across all metric containers - Updated for cleaner cards */
	.hero-metrics > :global(*),
